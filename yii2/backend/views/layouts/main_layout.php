  ...
  <div id="main">
    ...
    <header class="navbar navbar-fixed-top navbar-shadow">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="/yii2/frontend/web/">返回前端</a></li>
      </ul>
 <ul class="nav navbar-nav navbar-right">
      ...
      <div class="sidebar-left-content nano-content">
        ...
        <ul class="nav sidebar-menu">
            ...
            <li>
              ...
              <?php if(!Yii::$app->user->isGuest){ ?>
                <a href="<?php echo Url::to(['assignment/personal','id'=>'1']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 周钰宸</a>
                  <?php } else{?>
                  <a href="<?php echo Url::to(['site/logout']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 周钰宸</a>
                  <?php } ?>
              ...
              <?php if(!Yii::$app->user->isGuest){ ?>
                <a href="<?php echo Url::to(['assignment/personal','id'=>'2']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 武桐西</a>
                  <?php } else{?>
                  <a href="<?php echo Url::to(['site/logout']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 武桐西</a>
                  <?php } ?>
              ...
              <?php if(!Yii::$app->user->isGuest){ ?>
			            <a href="<?php echo Url::to(['assignment/personal','id'=>'3']) ?>">
			                    <span class="glyphicon glyphicon-book"></span> 胡亚飞</a>
			                    <?php } else{?>
			            <a href="<?php echo Url::to(['site/logout']) ?>">
			                    <span class="glyphicon glyphicon-book"></span> 胡亚飞</a>
			                    <?php } ?>
              ...
              <?php if(!Yii::$app->user->isGuest){ ?>
			                  <a href="<?php echo Url::to(['assignment/personal','id'=>'4']) ?>">
			                    <span class="glyphicon glyphicon-book"></span> 纪潇洋</a>
			                    <?php } else{?>
			                    <a href="<?php echo Url::to(['site/logout']) ?>">
			                    <span class="glyphicon glyphicon-book"></span> 纪潇洋</a>
			                    <?php } ?>
          ...
          <li>
            <a class="accordion-toggle" href="">
              <span class="glyphicon glyphicon-fire"></span>
              <span class="sidebar-title">增删改查</span>
              <span class="caret"></span>
            </a>
            <ul class="nav sub-nav">
              <li>
              ...
              <li>
              <?php if(!Yii::$app->user->isGuest){ ?>
                <a href="<?php echo Url::to(['measures/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span> measures</a>
                  <?php } else{?>
                  <a href="<?php echo Url::to(['site/login']) ?>">
                  <span class="glyphicon glyphicon-book"></span> measures</a>
                  <?php } ?>
              ...
              <?php if(!Yii::$app->user->isGuest){ ?>
			            <a href="<?php echo Url::to(['event/index']) ?>">
			              <span class="glyphicon glyphicon-book"></span> event</a>
			              <?php } else{?>
			            <a href="<?php echo Url::to(['site/login']) ?>">
			              <span class="glyphicon glyphicon-book"></span> event</a>
			            <?php } ?>
            ...
            <li>
              ...
              <li>
              <?php if(!Yii::$app->user->isGuest){ ?>
                <a href="<?php echo Url::to(['ch-element/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span> chelement</a>
                  <?php } else{?>
                  <a href="<?php echo Url::to(['site/login']) ?>">
                  <span class="glyphicon glyphicon-book"></span> chelement</a>
                  <?php } ?>
              ...
              <li>
              <?php if(!Yii::$app->user->isGuest){ ?>
                <a href="<?php echo Url::to(['detection/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span> detection</a>
                  <?php } else{?>
                  <a href="<?php echo Url::to(['site/login']) ?>">
                  <span class="glyphicon glyphicon-book"></span> detection</a>
                  <?php } ?>
              ...
              <li>
              <?php if(!Yii::$app->user->isGuest){ ?>
                <a href="<?php echo Url::to(['sea/index']) ?>">
                  <span class="glyphicon glyphicon-book"></span> sea</a>
                  <?php } else{?>
                  <a href="<?php echo Url::to(['site/login']) ?>">
                  <span class="glyphicon glyphicon-book"></span> sea</a>
                  <?php } ?>
          ...
          <li class="sidebar-label pt25 pb10">成员能力</li>
          <li class="sidebar-stat">
            <a href="#projectOne" class="fs11">
              <span class="fa fa-inbox text-info"></span>
              <span class="sidebar-title text-muted">前端能力</span>
              ...
              <div class="progress progress-bar-xs mh20 mb10">
                <div class="progress-bar progress-bar-info" role="progressbar" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100" style="width: 35%">
                  <span class="sr-only">49.12% Complete</span>
                </div>
              </div>
            </a>
          </li>
          <li class="sidebar-stat">
            <a href="#projectOne" class="fs11">
              ...
              <span class="sidebar-title text-muted">后端能力</span>
              <span class="pull-right mr20 text-muted">63.33%</span>
              <div class="progress progress-bar-xs mh20">
                <div class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100" style="width: 58%">
                  <span class="sr-only">63.33% Complete</span>
                </div>
              </div>
            </a>
          </li>
