        ...
        <div class="row">
            <div class="col-md-11">
                <div class="blog-single-box clearfix animated out" data-delay="0" data-animation="fadeInUp">
                    ...
                    <a href="/yii2/backend/web/index.php?r=assignment%2Fpersonal&id=1" class="btn">MY
                ...
                <div class="blog-single-box clearfix animated out" data-delay="0" data-animation="fadeInUp">
                    ...
                    <a href="/yii2/backend/web/index.php?r=assignment%2Fpersonal&id=2" class="btn">MY
                        WORK<i class="fa fa-arrow-right"></i></a>
                </div>
                <div class="blog-single-box clearfix animated out" data-delay="0" data-animation="fadeInUp">
                    ...
                    <a href="/yii2/backend/web/index.php?r=assignment%2Fpersonal&id=3" class="btn">MY
                        WORK<i class="fa fa-arrow-right"></i></a>
                </div>
                <div class="blog-single-box clearfix animated out" data-delay="0" data-animation="fadeInUp">
                    ...
                    <a href="/yii2/backend/web/index.php?r=assignment%2Fpersonal&id=4" class="btn">MY
                        WORK<i class="fa fa-arrow-right"></i></a>
                </div>
            </div>
        </div>
