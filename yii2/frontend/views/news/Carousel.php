   ...
   <li class="lb-item">
    ...
    <div>
        <div class="header">
            ...
            <span class="country"><?=$data[0]['wsymbol']?></span>
        </div>
    </a>
    ...
    <div>
        <div class="header">
            ...
            <span class="country"><?=$data[1]['wsymbol']?></span>
        </div>
    </a>
    ...
    <div>
        <div class="header">
            ...
            <span class="country"><?=$data[2]['wsymbol']?></span>
        </div>
    </a>
    ...
    <div>
        <div class="header">
            ...
            <span class="country"><?=$data[3]['wsymbol']?></span>
        </div>
    </a>
    ...
    <div>
        <div class="header">
            ...
            <span class="country"><?=$data[4]['wsymbol']?></span>
        </div>
    </a>
